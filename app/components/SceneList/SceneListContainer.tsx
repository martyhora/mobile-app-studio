...
export default class SceneListContainer extends React.Component<ISceneListContainerProps, ISceneListContainer> {
    constructor() {
        super();
    ...
    handleSceneSave(): void {
        ...
        if (!id) {
            SceneApi.addScene({ title, applicationId: this.props.match.params.id, sections: [] }, onSectionSaved);
        } else {
